...
- Add support for special characters in L<sup>A</sup>T<sub>E</sub>X: `\L` (&#x0141;), `\SS` (&#x1e9e;), `\i` (&#x0131;), `\j` (&#x0237;), and `\l` (&#x0142;) ([PR ltex-ls#57](https://github.com/valentjn/ltex-ls/pull/57) by [@ed359](https://github.com/ed359), fixes [ltex-ls#56](https://github.com/valentjn/ltex-ls/issues/56))
...
- Use L<sup>A</sup>T<sub>E</sub>X parser for documents with code language ID `tex` ([PR ltex-ls#54](https://github.com/valentjn/ltex-ls/pull/54) by [Lucas Alber (@LDAP)](https://github.com/LDAP), fixes [ltex-ls#53](https://github.com/valentjn/ltex-ls/issues/53))
